...
const HeroSection = () => {
  ...
  return (
    <section className="min-h-screen flex flex-col relative bg-background pt-14 overflow-hidden">
      {/* Subtle background accent */}
      <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-primary/[0.03] rounded-full blur-[160px] pointer-events-none" />
      ...
      <div className="flex-1 flex items-center justify-center">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-28 relative z-10">
          <div className="max-w-3xl mx-auto text-center space-y-8">
            {/* Badge */}
            <div className="inline-flex items-center gap-2 border border-border/80 bg-surface px-3.5 py-1.5 rounded-full text-[11px] font-semibold text-muted-foreground tracking-wide uppercase select-none">
              <span className="w-1.5 h-1.5 rounded-full bg-primary animate-pulse" />
              Enterprise async interviews
            </div>

            {/* Headline */}
            <h1 className="text-4xl sm:text-5xl lg:text-[3.5rem] font-bold tracking-[-0.03em] text-foreground leading-[1.1] max-w-2xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center pt-2">
              <Button
                size="lg"
                className="font-semibold px-7 h-11 shadow-sm"
              ...
              <Button
                variant="outline"
                size="lg"
                className="font-semibold px-7 h-11"
                onClick={() => navigate("/signup")}
              >
                See how it works
              </Button>
            ...
            {/* Trust signals */}
            <div className="flex items-center justify-center gap-6 pt-6 text-[13px] text-muted-foreground border-t border-border/60 max-w-md mx-auto">
      ...
      <div className="border-t border-border/60 bg-surface/50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
          <div className="max-w-5xl mx-auto">
            {/* Mock browser chrome */}
            <div className="bg-card border border-border/80 rounded-xl shadow-2xl overflow-hidden">
              {/* Title bar */}
              <div className="h-9 border-b border-border/60 bg-secondary/40 flex items-center justify-between px-4">
                <div className="flex items-center gap-1.5">
                  <div className="w-2.5 h-2.5 rounded-full bg-muted-foreground/20" />
                  <div className="w-2.5 h-2.5 rounded-full bg-muted-foreground/20" />
                  <div className="w-2.5 h-2.5 rounded-full bg-muted-foreground/20" />
                </div>
                <div className="text-[10px] font-medium text-muted-foreground/70 bg-background/60 border border-border/40 px-5 py-0.5 rounded">
              ...
              <div className="flex flex-col md:flex-row min-h-[340px]">
                ...
                <div className="flex-1 p-6 flex flex-col gap-4">
                  <div className="space-y-1.5">
                    <span className="text-[10px] font-bold uppercase tracking-wider text-primary">Question 2 of 5</span>
                    <h3 className="text-sm font-semibold text-foreground leading-snug">
                      Describe your approach to designing a scalable microservices architecture.
                    </h3>
                  </div>

                  <div className="flex-1 bg-secondary/30 rounded-lg border border-border/60 flex flex-col items-center justify-center relative">
                    ...
                    {/* Live indicator */}
                    <div className="absolute top-3 right-3 flex items-center gap-1.5 bg-background/80 backdrop-blur-sm border border-border/80 px-2 py-0.5 rounded-full">
                      <span className="w-1.5 h-1.5 bg-destructive rounded-full animate-pulse" />
                      <span className="text-[8px] font-bold uppercase tracking-wider text-foreground">Live</span>
                    </div>

                    {/* Waveform */}
                    <div className="absolute bottom-3 left-3 right-3 h-7 bg-background/80 backdrop-blur-sm border border-border/80 rounded-md p-1.5 flex items-center gap-px">
                      {[40, 65, 50, 85, 70, 55, 30, 60, 80, 75, 45].map((h, i) => (
                        <div key={i} className="flex-1 bg-primary/50 rounded-full" style={{ height: `${h}%` }} />
                      ))}
                      <span className="text-[8px] font-medium text-muted-foreground ml-1">01:04</span>
                    </div>
                  </div>
                </div>

                {/* AI evaluation sidebar */}
                <div className="w-full md:w-52 border-t md:border-t-0 md:border-l border-border/60 p-5 flex flex-col gap-4 bg-secondary/10">
                  <div className="flex items-center justify-between">
                    <span className="text-[11px] font-bold text-foreground">AI Evaluator</span>
                    <span className="text-[9px] font-bold uppercase tracking-wider bg-success/10 text-success px-1.5 py-0.5 rounded border border-success/20">
                      Active
                    </span>
                  </div>
                  ...
                  <div className="flex flex-col items-center py-2">
                    ...
                    <span className="text-[9px] text-muted-foreground uppercase font-bold tracking-wider mt-1">Score</span>
                  </div>
                  ...
                  <div className="bg-primary/[0.05] border border-primary/15 rounded-md p-2.5 space-y-1 mt-auto">
